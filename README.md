...
- **Models:** Kie dropdowns default to **V6** (flagship). Also **V6_WILD** (experimental) and **V6_MINI** (fast drafts). Legacy V4–V5_5 remain available but are deprecated. After **Generate**, the model from **Generation settings** syncs to all Kie tabs; v6 custom-mode jobs can pass **duration** (10–360s) from the duration target in settings.
